...
abstract class FlutterBoomNotificationPluginsPlatform
    extends PlatformInterface {
  /// Constructs a FlutterBoomNotificationPluginsPlatform.
  FlutterBoomNotificationPluginsPlatform() : super(token: _token);

  static final Object _token = Object();

  static FlutterBoomNotificationPluginsPlatform _instance =
      MethodChannelFlutterBoomNotificationPlugins();

  /// The default instance of [FlutterBoomNotificationPluginsPlatform] to use.
  ///
  /// Defaults to [MethodChannelFlutterBoomNotificationPlugins].
  static FlutterBoomNotificationPluginsPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [FlutterBoomNotificationPluginsPlatform] when
  /// they register themselves.
  static set instance(FlutterBoomNotificationPluginsPlatform instance) {
