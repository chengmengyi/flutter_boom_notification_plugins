...
object KeepAliveNotificationHelper {
    ...
    fun startOrUpdateForegroundService(
        ...
        if (!ignoreNotificationPermission &&
            !FlutterBoomNotificationPluginsPlugin.canPostNotifications(context)
        ) {
    ...
    fun showStoredLocalNotification(
        ...
        try {
            ...
            FlutterBoomNotificationPluginsPlugin.playNotificationFeedbackIfNeeded(context, payload)
            FlutterBoomNotificationPluginsPlugin.notifyWithHeadsUpRefreshIfNeeded(
                context = context,
    ...
    private fun resolveSmallIcon(context: Context): Int {
        return FlutterBoomNotificationPluginsPlugin.resolveNotificationSmallIcon(context)
    }
