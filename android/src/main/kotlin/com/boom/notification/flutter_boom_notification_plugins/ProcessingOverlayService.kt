...
class ProcessingOverlayService : Service() {
    companion object {
        ...
        const val ACTION_NOTIFICATION_CLICK =
            "com.boom.notification.flutter_boom_notification_plugins.PROCESSING_OVERLAY_CLICK"
        ...
        private fun ProcessingOverlayReflectionConfig.decode(value: String): String {
            return FlutterBoomNotificationPluginsPlugin.decryptReflectionString(secret, value)
        }
    ...
    private fun handleOverlayClick() {
        ...
        val started =
            FlutterBoomNotificationPluginsPlugin.startProcessingOverlayClickIntent(
                applicationContext,
            )
        if (!started) {
            FlutterBoomNotificationPluginsPlugin.dispatchProcessingOverlayClicked(
                applicationContext,
            )
        }
    }
    ...
    private fun resolveSmallIcon(): Int {
        return FlutterBoomNotificationPluginsPlugin.resolveNotificationSmallIcon(this)
    }
