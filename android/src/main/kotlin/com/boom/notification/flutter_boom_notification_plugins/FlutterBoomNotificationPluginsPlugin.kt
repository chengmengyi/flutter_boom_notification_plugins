...
class FlutterBoomNotificationPluginsPlugin :
    ...
    private fun encryptReflectionString(
        ...
        result.success(FlutterBoomNotificationPluginsPlugin.encryptReflectionString(secret, value))
    }
    ...
    private fun decryptReflectionString(
        ...
        try {
            result.success(FlutterBoomNotificationPluginsPlugin.decryptReflectionString(secret, value))
        } catch (error: Exception) {
            result.error(
