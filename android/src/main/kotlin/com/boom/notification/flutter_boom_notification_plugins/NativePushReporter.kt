...
internal object NativePushReporter {
    ...
    fun reportDisplayed(context: Context, arguments: Map<String, Any?>) {
        ...
        if (config == null) {
            FlutterBoomNotificationPluginsPlugin.dispatchNotificationDisplayed(appContext, arguments)
            return
        }
    ...
    fun finalFallback(context: Context, eventId: String, event: JSONObject) {
        ...
        FlutterBoomNotificationPluginsPlugin.dispatchNotificationDisplayed(context, arguments)
    }
